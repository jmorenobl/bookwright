...
<p align="center">
  ...
  <a href="https://github.com/jmorenobl/bookwright/blob/main/CHANGELOG.md"><img src="https://img.shields.io/badge/version-0.5.13-6f42c1" alt="Versión 0.5.13"></a>
...
> Estado: **v0.5.13** — usable para investigar, estructurar, redactar y
...
> cuando no tiene nada que mirar. El juicio semántico ha aterrizado su
> primera ola completa: `bookwright-continuity` detecta ahora personajes
> usados en la prosa pero nunca declarados en la biblia, head-hopping bajo
> focalización en tercera limitada, y rupturas de voz en primera persona que
> se cuelan en una narración en tercera — tres dimensiones de una pasada de
> continuidad asistida por LLM que se mantiene fuera del gate determinista.
> Detalle de cambios en el
