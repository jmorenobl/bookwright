...
SKILL_DESCRIPTIONS: dict[str, str] = {
    ...
    "bookwright-continuity": 'Revisa la consistencia POST-redacción del manuscrito frente a la biblia: cumplimiento de la biblia, coherencia de los arcos de personaje y de la línea de tiempo, y personajes mencionados en la prosa pero sin ficha en bible/characters/. Check POST-draft continuity of the manuscript against the bible: bible compliance, character-arc consistency, timeline coherence, and characters used in the prose but undeclared (no sheet in bible/characters/). Úsalo cuando el autor pida "revisa si mi manuscrito es coherente con la biblia" / "check my manuscript against the bible", o "revisa si hay personajes sin declarar / mencionados pero sin ficha" / "check for undeclared / unbacked characters". Es de solo lectura y trabaja en fase POST-draft. NO revisa la planificación antes de redactar (eso es pre-draft: bookwright-analyze).',
