...
SKILL_DESCRIPTIONS: dict[str, str] = {
    ...
    "bookwright-continuity": 'Revisa la consistencia POST-redacción del manuscrito frente a la biblia: cumplimiento de la biblia, coherencia de los arcos de personaje y de la línea de tiempo, personajes mencionados en la prosa pero sin ficha en bible/characters/, y head-hopping / saltos de punto de vista. Check POST-draft continuity of the manuscript against the bible: bible compliance, character-arc consistency, timeline coherence, characters used in the prose but undeclared (no sheet in bible/characters/), and head-hopping / POV breaks. Úsalo cuando el autor pida "revisa si mi manuscrito es coherente con la biblia" / "check my manuscript against the bible", "revisa si hay personajes sin declarar / mencionados pero sin ficha" / "check for undeclared / unbacked characters", o "revisa head-hopping / saltos de punto de vista / focalización rota" / "check for head-hopping / POV breaks". Es de solo lectura y trabaja en fase POST-draft. NO revisa la planificación antes de redactar (eso es pre-draft: bookwright-analyze).',
