...
- [X] T016 [P] [US3] Write `docs/commands/` — one page or clearly delineated section per shipped command: `init`, `check`, `version`, `validate`, `graph build`, `graph query` (FR-012, DOC-2)
